...
```
Для создание экземпляра диалога нужно, как и для любых других компонентов использовать .ctor() функцию без аргументов
...
![Not found](./images/empty-window.png)

<table>
  <caption><h2><b>szlua события</b></h2></caption>
<thead>
    <tr>
      <th>Событие</th>
      <th>Описание</th>
  ...
  <tbody>
    <tr>
      <td>closed_event</td>
      <td>Происходит при закрытии диалогового окна</td>
      <td>75000</td>
      <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.windows.window.closed?view=windowsdesktop-10.0">Closed</a></td>
    </tr>
    <tr>
    <td>closed_event</td>
      <td>Происходит при закрытии диалогового окна</td>
