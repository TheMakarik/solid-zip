...
public sealed class Startup
{
    public IHost BuildHost()
    {
        ...
        hostBuilder.Services
            ...
            .AddWpfConverter<CountToBooleanConverter>()
            .AddWpfConverter<DirectoryCreationalLocalizationProblemConverter>()
            .AddWpfConverter<BooleanToVisibilityConverter>()
            .AddWpfConverter<SeventyPercentOfOpacityIfHiddenDirectoryConverter>()
            ...
            .AddWpfConverter<EnumToLocalizedStringConverter>()
            .AddWpfConverter<BooleanToOpacityConverter>()
