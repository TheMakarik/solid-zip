...
public sealed partial class DirectoryCreationViewModel : ViewModelBase
{
    ...
    private void CreateDirectory()
    {
        ...
        _messenger.Send(new AddToTheCurrentDirectoryContentMessage(path.ToDirectoryFileEntity()));
