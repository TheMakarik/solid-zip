...
public class ExplorerStateMachine(IExplorer explorer, ArchiveReaderFactory factory, IExplorerHistory history, IFileSystemStateMachine stateMachine) : IExplorerStateMachine
{
    public bool CanUndo => history.CanUndo;
    public bool CanRedo => history.CanRedo;
    public async ValueTask<Result<ExplorerResult, IEnumerable<FileEntity>>> GetContentAsync(FileEntity entity, bool addToHistory = true)
    {
